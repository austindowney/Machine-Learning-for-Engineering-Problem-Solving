...
plt.subplot(131)
n, bins, patches = plt.hist(np.array(metrics_sgd_accuracy)*100, x_bins, density=False, alpha=0.5,label='full data')
n, bins, patches = plt.hist(np.array(metrics_k_fold_accuracy)*100, x_bins, density=False, alpha=0.5,label='k-fold')
...
plt.subplot(132)
n, bins, patches = plt.hist(np.array(metrics_sgd_precision)*100, x_bins, density=False, alpha=0.5,label='full-data')
n, bins, patches = plt.hist(np.array(metrics_k_fold_precision)*100, x_bins, density=False, alpha=0.5,label='k-fold')
...
plt.subplot(133)
n, bins, patches = plt.hist(np.array(metrics_sgd_recall)*100, x_bins, density=False, alpha=0.5,label='full-data')
n, bins, patches = plt.hist(np.array(metrics_k_fold_recall)*100, x_bins, density=False, alpha=0.5,label='k-fold')
plt.xlabel(r'recall (\%)')
#plt.ylabel('count')
plt.xlim(30, 100)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('k-fold_cross-validation_trials.png',dpi=275)
