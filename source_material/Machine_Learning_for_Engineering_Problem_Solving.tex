...
\usepackage{downey_format}		% Loads the custom style package.
...
\fancypagestyle{firstpagestyle}
{
    ...
    \fancyfoot[L]{\href{https://doi.org/10.31224/4909}{DOI:10.31224/4909}}% \\ Persistent OSF \href{https://osf.io/preprints/osf/uh3yz}{link}} % Text on the left side of the footer
}
% persistent URL https://osf.io/preprints/osf/uh3yz (use for things that may link to multiple versions of the same text like a webpage.


\begin{document}

%\thispagestyle{empty}	% Use thiis page style if you don't want to list the DOI
...
This preface collects the essential housekeeping information for using this text.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5.8in]{figures/video_playlist}
	\vspace{-0.5ex}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5.8in]{figures/python_playlist}
	\vspace{-0.5ex}
...
\include{Chapter_3_Machine_Learning_Workflows/Chapter_3_Machine_Learning_Workflows}

% Chapter 4 Classification
\include{Chapter_4_Classification/Chapter_4_Classification}

% Chapter 5 Classification
\include{Chapter_5_Regression-based_Classification/Chapter_5_Regression-based_Classification}

% Chapter 6 Decision Trees
\include{Chapter_6_Decision_Trees/Chapter_6_Decision_Trees}

% Chapter 7 Support Vector Machines
\include{Chapter_7_Support_Vector_Machines/Chapter_7_Support_Vector_Machines}

% Chapter 8 Regression-based Classification
\include{Chapter_8_Clustering/Chapter_8_Clustering}

% Chapter 9 Dimensionality Reduction
\include{Chapter_9_Dimensionality_Reduction/Chapter_9_Dimensionality_Reduction}
