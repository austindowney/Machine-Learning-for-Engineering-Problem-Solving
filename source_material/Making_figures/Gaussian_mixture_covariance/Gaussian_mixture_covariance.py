...
for ii, covariance_type in enumerate(covariance_types):
    ...
    for j in range(3):
        ...
        if covariance_type == 'spherical':
            cov = np.eye(2) * gmm.covariances_[j]
    ...
    ax.set_title(r'covariance type = ' + covariance_type)
...
#%% Save figure
plt.tight_layout()
plt.savefig('Gaussian_mixture_covariance.jpg',dpi=300)