...
\section{Chapter~7~Decision Trees}
...
\begin{frame}{Decision Trees}
	\begin{columns}
		...
		\centering
		\includegraphics[width=\textwidth]{../figures/decision_tree_basic_concept}
...
\begin{frame}{Class Probability Estimation}
	...
	\[
	P(\text{versicolor}) = \frac{49}{54}=90.7\%
	\]
	
	\[
	P(\text{virginica}) = \frac{5}{54}=9.3\%
	\]
...
\begin{frame}{Example 7.1: Decision Tree Classifier}
...
%	\vspace{0.5em}
%	
%	Regularization limits how much freedom the tree has during training.
%	
%	\vspace{0.5em}
%	
...
%	
%	\begin{itemize}
%		\item Decrease \texttt{max\_*} values
%		\item Increase \texttt{min\_*} values
%	\end{itemize}
%	
%\end{frame}
%
...
%		\column{0.58\textwidth}
%		\centering
%		\includegraphics[width=\textwidth]{../figures/decision_tree_regression}
%		
%		\vspace{0.3em}
...
%------------------------------------------------
%
%\begin{frame}{Example 7.2: Decision Tree Regression}
%	
%	\begin{itemize}
