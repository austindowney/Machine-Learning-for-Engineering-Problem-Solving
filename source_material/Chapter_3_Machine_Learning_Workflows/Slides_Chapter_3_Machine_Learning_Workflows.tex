...
\begin{frame}{Machine Learning Workflows}
	\begin{columns}
		...
		\centering
		\includegraphics[width=\textwidth]{../figures/ML_workflow}
		
		\vspace{0.3em}
		{\small Typical machine learning workflow.}
	\end{columns}
\end{frame}
...
\begin{frame}{Feature Engineering}
	\begin{columns}
		...
		\begin{itemize}
			...
			\item physical relationships
		\end{itemize}
				
		\column{0.52\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../figures/feature_engineering}
		
		\vspace{0.3em}
		{\small Transforming raw data into a feature vector.}
	\end{columns}
\end{frame}
...
\begin{frame}{Statistical Features}
	...
	\begin{table}
		\centering
		\scriptsize
		\begin{tabular}{p{0.10\textwidth} p{0.34\textwidth} p{0.5\textwidth}}
			\hline
			\textbf{No.} & \textbf{Feature} & \textbf{Interpretation} \\
			\hline
	...
	{\scriptsize * The full equations are provided in Table 1 of Chapter 3 in the accompanying text.}
\end{frame}
...
\begin{frame}{Time-Series Features}
	...
	{\scriptsize * The full equations are provided in Table 2 of Chapter 3 in the accompanying text.}
\end{frame}

%------------------------------------------------

\begin{frame}{Frequency-Domain Features}
	...
	{\scriptsize * The full equations are provided in Table 3 of Chapter 3 in the accompanying text.}
\end{frame}


%------------------------------------------------

\section{3.2~Training and Testing Data}
...
\begin{frame}{Example 3.1: Learning Curves}
...
%------------------------------------------------
\section{3.5~Regularized Linear Models}
...
\begin{frame}{Example 3.2: Ridge Regression}
...
\begin{frame}{Example 3.3: Early Stopping}
