...
\begin{frame}{Polynomial Regression}
	\begin{columns}
		...
		\begin{itemize}
			\item Linear models underfit nonlinear data
			\item Polynomial terms allow curved fits
			\item Still linear in the parameters
		\end{itemize}
		
		\column{0.52\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../figures/polynomial_regression_1}
		
		\vspace{0.3em}
		{\small Dataset generated from a quadratic relationship.}
...
\begin{frame}{Feature Expansion}
	\begin{columns}
		...
		\begin{itemize}
			\item Add higher-order terms as new features
			\item Train a linear model on the expanded data
			\item Allows nonlinear behavior
		\end{itemize}
		
		\column{0.52\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../figures/polynomial_regression_2}
		
		\vspace{0.3em}
		{\small Linear fits to the expanded feature set.}
...
\begin{frame}{Polynomial Model Fit}
	\begin{columns}
		...
		\begin{itemize}
			\item $a$: quadratic term
			\item $b$: linear term
			\item $c$: bias/intercept
		\end{itemize}
		...
		\column{0.52\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../figures/polynomial_regression_3}
		
		\vspace{0.3em}
		{\small Polynomial regression fit.}
...
\begin{frame}{Polynomial Features}
	...
	\begin{itemize}
		...
		\item Implemented with:
	\end{itemize}
	
	\[
	\texttt{PolynomialFeatures(degree=d)}
	\]
...
\begin{frame}{Combinatorial Explosion}
	...
	\begin{itemize}
		\item $n$: original number of features
	...
	\begin{itemize}
		\item Increase memory usage
		\item Slow training
		\item Cause overfitting
	\end{itemize}
...
\begin{frame}{Example 2.2: Polynomial Regression}
	
	\begin{itemize}
		\item Fit a nonlinear dataset using polynomial regression
		\item Add $x^2$ as an additional feature
		\item Train a linear model on the expanded feature set
	\end{itemize}
	...
	Demonstrates how:
	\begin{itemize}
		\item Linear models can approximate curved relationships
		\item Polynomial terms improve model flexibility
		\item The resulting fit compares to the original data
	\end{itemize}
