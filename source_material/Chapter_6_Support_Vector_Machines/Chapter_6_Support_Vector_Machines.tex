...
\begin{figure}[H]
	...
	\caption{Nonlinear SVM example and illustration that shows: (a) not linearly separable 2D Data, and (b) the same data plotted in a transformed feature space such that is is now linearly separable.}
